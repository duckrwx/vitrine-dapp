...
// Este componente agora é focado APENAS na gestão da persona.
export default function UserDashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* O painel de status e o formulário de atualização da persona continuam aqui */}
      ...
      {/* A secção "Ações de Vendedor" foi removida daqui */}
    </div>
  );
}
